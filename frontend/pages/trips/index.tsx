...
import CitiesClientsModal from './CitiesClientsModal'
...
export default function Trips() {
  ...
  // useEffect para buscar os dados iniciais: cidades, veículos, trabalhadores, configurações e tipos de serviço
  ...
  // useEffect para buscar despesas do veículo selecionado sempre que ele mudar (ou seja, ao abrir o modal de edição de viagem e selecionar um veículo diferente)
  useEffect(() => {
    fetchVehicleExpenses(selectedVehicleId ?? undefined)
  }, [selectedVehicleId, fetchVehicleExpenses])

  // useEffects para focar os inputs dos modais de notas extras e notas de combustível quando eles forem abertos
  useEffect(() => {
  ...
  // funções para abrir os modais de criação e edição de viagem, preenchendo o formulário com os dados da viagem a ser editada ou com os valores padrão para uma nova viagem
